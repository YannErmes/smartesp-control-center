...
const AvantagesSection: React.FC = () => {
  const avantages = [
    ...
    },
    {
      ...
      description: "Support complet de l'écosystème OSP avec détection automatique des modules.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "API robuste",
      description: "Contrôlez vos appareils via notre API RESTful ou notre bibliothèque Python pour une intégration facile.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
