        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0 fade-in">
            ...
            <p className="text-xl md:text-2xl mb-6 text-gray-300">
              Contrôlez vos modules OSP en un clic
            </p>
            <p className="text-gray-400 mb-6 max-w-lg">
              Une interface intuitive pour gérer l'ensemble de vos modules OSP32CAM, OSP32Simple et autres appareils compatibles de manière centralisée.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="stp" spy={true} smooth={true} offset={-80} duration={500}>
...
# SmartESP gère tout pour vous!`}
                ...
                <div className="mt-4 flex justify-between">
                  <div className="text-xs text-green-400 mono">● Connecté à OSP32CAM</div>
